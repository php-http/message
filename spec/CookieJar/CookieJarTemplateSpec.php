...
namespace spec\Http\Message\CookieJar;

use Http\Message\Cookie;
use Http\Message\CookieJar;
use Http\Message\CookieJar\CookieJarTemplate;
use PhpSpec\ObjectBehavior;

class CookieJarTemplateSpec extends ObjectBehavior
{
    function let()
    {
        $this->beAnInstanceOf('spec\Http\Message\CookieJar\DummyCookieJar');
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('spec\Http\Message\CookieJar\DummyCookieJar');
    }

    function it_is_a_cookie_jar()
    {
        $this->shouldImplement('Http\Message\CookieJar');
    }
